...
public class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void>{
	...
	/**
	 * Resolving the super expression as if it were a variable
	 * Resolution stores the number of hops up the environment chain to the environment where the superclass is stored
	 * @param expr the superclass expression
	 */
	@Override
